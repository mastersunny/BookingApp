...
public class HotelListActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener, GuestSelectFragment.GuestSelectListener {

    private static String TAG = "HotelListActivity";
    ...
    private void initLayout() {
        ...
        rv_rooms.setAdapter(hotelAdapter);
        hotelAdapter.setItemSelectListener(new ItemSelectListener() {
            @Override
            public void onItemSelect(Object selectedItem, int action) {
                switch (action) {
                    case Constants.ACTION_DETAILS:
                        startRoomListActivity((HotelResponseDto) selectedItem);
                        break;
                }
            }
        });
    ...
    private void startRoomListActivity(HotelResponseDto selectedItem) {
        Intent intent = new Intent(this, RoomListActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
        intent.putExtra(Constants.HOTEL_DTO, selectedItem);
    ...
    private void loadPlaceDetails() {
        apiInterface.getPlaceDetailsFromGoogle(placeId, "geometry(location)",
            ...
            public void onFailure(Call<GooglePlaceDetails> call, Throwable t) {
                Toast.makeText(HotelListActivity.this, t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
